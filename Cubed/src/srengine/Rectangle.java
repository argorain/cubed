...
/**
 * This class represents rectangle with specific width, height and angle of rotation
 * 
...
public class Rectangle implements IHitBox {
    ...
    /**
     * Draw method. Rotate graphic context, draw and reset graphic transformation
     * 
     * @param g
     *          Graphic context
     * @param gc 
